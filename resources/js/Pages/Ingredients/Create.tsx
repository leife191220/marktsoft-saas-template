...
import { PageProps, Category, MeasureUnit } from '@/types';
...
export default function Create({ auth, categories, units = [] }: Props) {
            ...
            header={
                <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                    <h2 className="text-2xl font-black leading-tight text-white tracking-tight">
                        ...
                        <span className="text-slate-600">/</span> <span className="text-orange-400">Nuevo Insumo</span>
                    </h2>
                </div>
            }
        >
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    className="w-full bg-slate-900/50 border border-slate-700 rounded-xl text-white placeholder-slate-500 focus:border-orange-500 focus:ring-orange-500 transition-colors"
                                    placeholder="Ej: Ron Viejo de Caldas, Limón, Vasos..."
                                />
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <select
                                        ...
                                        className="w-full bg-slate-900/50 border border-slate-700 rounded-xl text-white focus:border-orange-500 focus:ring-orange-500 transition-colors"
                                    >
                                ...
                                <div>
                                    ...
                                    <select
                                        ...
                                        className="w-full bg-slate-900/50 border border-slate-700 rounded-xl text-orange-400 font-bold focus:border-orange-500 focus:ring-orange-500 transition-colors"
                                    >
                            ...
                            <div className="bg-orange-900/10 border border-orange-500/20 rounded-xl p-5">
                                <h4 className="text-orange-400 font-bold mb-3 flex items-center">
                                    ...
                                    Calculadora Inteligente de Bodega
                                </h4>
                                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                                    <div>
                                        ...
                                        <input type="number" placeholder="Ej: 40000" value={calcPrice} onChange={e => setCalcPrice(e.target.value)} className="w-full bg-slate-900/50 border-orange-500/30 rounded-lg text-white text-sm focus:border-orange-500 focus:ring-orange-500" />
                                    </div>
                                    <div>
                                        ...
                                        <input type="number" placeholder="Ej: 750" value={calcCapacity} onChange={e => setCalcCapacity(e.target.value)} className="w-full bg-slate-900/50 border-orange-500/30 rounded-lg text-white text-sm focus:border-orange-500 focus:ring-orange-500" />
                                    </div>
                                    <div>
                                        <label className="block text-xs text-slate-400 mb-1">¿Cuántas botellas <span className="text-orange-400 font-bold">compraste</span>?</label>
                                        <input type="number" placeholder="Ej: 10" value={calcQuantity} onChange={e => setCalcQuantity(e.target.value)} className="w-full bg-slate-900/50 border-orange-500/30 rounded-lg text-white text-sm focus:border-orange-500 focus:ring-orange-500" />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 bg-slate-900/30 p-5 rounded-xl border border-slate-700/50">
                                <div>
                                    <label className="block text-sm font-bold text-slate-300 mb-2">Stock Inicial Total en Bodega</label>
                                    <div className="relative">
                                        <input
                                            ...
                                            className="w-full bg-slate-900/50 border border-slate-700 rounded-xl text-white placeholder-slate-500 focus:border-orange-500 focus:ring-orange-500 transition-colors pr-12"
                                        />
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        className="w-full bg-slate-900/50 border border-slate-700 rounded-xl text-emerald-400 font-bold placeholder-slate-500 focus:border-orange-500 focus:ring-orange-500 transition-colors"
                                    />
                            ...
                            <div className="flex justify-end gap-4 pt-6 mt-6 border-t border-slate-700">
                                ...
                                <button
                                    type="submit"
                                    disabled={processing}
                                    className="px-6 py-3 bg-orange-600 border border-transparent rounded-xl text-sm font-bold text-white hover:bg-orange-500 transition-all shadow-lg shadow-orange-500/30 disabled:opacity-50"
                                >
